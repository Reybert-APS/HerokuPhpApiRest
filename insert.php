...
if(isset($data->identificacion) && !empty($data->nombre) && !empty($data->curso) && !empty($data->nota1) && !empty($data->nota2) && !empty($data->nota3)){
    ...
    $msg['message'] = 'Por favor diligenciar todos los campos | identificacion, nombre, curso, nota uno, nota dos, nota tres';
}
